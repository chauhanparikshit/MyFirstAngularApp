...
var routes = [
    ...
    { path: "edit/:id", component: _create_create_component__WEBPACK_IMPORTED_MODULE_3__["CreateComponent"] }
];
...
module.exports = "<h2 [hidden]=\"user.UserId!=undefined\">Create</h2>\n<h2 [hidden]=\"!user.UserId!=undefined\">Edit</h2>\n\n<hr>\n<form #form=\"ngForm\" (ngSubmit)=\"saveData(form)\">\n  <div>\n    Name :\n    <input type=\"text\" name=\"name\" #name=\"ngModel\" [(ngModel)]=\"user.Name\" />\n  </div>\n  <div>\n    Address :\n    <textarea name=\"address\" #address=\"ngModel\" [(ngModel)]=\"user.Address\"></textarea>>\n  </div>\n  <div>\n    Contact :\n    <input type=\"text\" name=\"contact\" #contact=\"ngModel\" [(ngModel)]=\"user.Contact\" />\n  </div>\n  <div>\n    <input type=\"submit\" value=\"Save\" />\n  </div>\n</form>\n"
...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(userService, router, route) {
    ...
    CreateComponent.prototype.saveData = function (form) {
        var _this = this;
        if (form.valid) {
    ...
    CreateComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
    ], CreateComponent);
...
var UserService = /** @class */ (function () {
    function UserService(httpClient) {
        ...
        this.url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiAddress;
    ...
    UserService.prototype.addUser = function (user) {
        return this.httpClient.post(this.url + '/user', JSON.stringify(user), { headers: this.headers, observe: 'response' });
    };
    UserService.prototype.updateUser = function (user) {
        return this.httpClient.put(this.url + '/user/' + user.UserId, JSON.stringify(user), { headers: this.headers, observe: 'response' });
    };
...
module.exports = "<h2></h2>\n<hr>\n<table class=\"table table-bordered table-hover\">\n  <thead>\n    <tr>\n      <th>UserId</th>\n      <th>Name</th>\n      <th>Address</th>\n      <th>Contact</th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor=\"let item of users\">\n      <td>{{item.UserId}}</td>\n      <td>{{item.Name}}</td>\n      <td>{{item.Address}}</td>\n      <td>{{item.Contact}}</td>\n      <td>\n<button type=\"button\" (click)=\"deleteUser(item.UserId)\">Delete</button>\n<a [routerLink]=\"['/edit',item.UserId]\" class=\"btn btn-warning\">Edit</a>\n\n      </td>\n    </tr>\n  </tbody>\n</table>\n"
...
module.exports = __webpack_require__(/*! C:\bootcamp\angular_express\client\src\main.ts */"./src/main.ts");
